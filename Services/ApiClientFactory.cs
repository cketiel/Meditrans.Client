...
namespace Meditrans.Client.Services
{
    ...
    {
        private static readonly string _baseUrl = App.Configuration["ApiAddress:ApiService"];  // App.Configuration["ApiAddress:ApiTest"]; // App.Configuration["ApiAddress:TripsService"];// App.Configuration["ApiAddress:GatewayService"];
